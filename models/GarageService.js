...
const garageServiceSchema = new mongoose.Schema({
  ...
  category: {
    ...
    required: true,
    enum: [
      'Engine Repair', 'Brake Service', 'Oil Changes', 'Transmission Repair',
      'AC Repair', 'Diagnostics', 'Tire Service', 'Battery Service',
      'Suspension Repair', 'Electrical Work', 'Body Work', 'Paint Service',
      'Detailing', 'Towing', 'Emergency Service', 'Hybrid Service',
      'Diesel Service', 'Performance Tuning', 'Restoration', 'Custom Work'
    ]
  },
